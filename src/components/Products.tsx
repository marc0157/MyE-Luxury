...
const products = [
  ...
  // ... resto de productos con la misma estructura
];
...
export default function Products() {
  ...
  const nextImage = () => {
    if (selectedProduct) {
      setCurrentImageIndex((prev) => 
        prev === selectedProduct.additionalImages.length ? 0 : prev + 1
      );
    }
  };
  ...
  const prevImage = () => {
    if (selectedProduct) {
      setCurrentImageIndex((prev) => 
        prev === 0 ? selectedProduct.additionalImages.length : prev - 1
      );
    }
  };
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 p-6">
                ...
                <div className="relative">
                  <div className="aspect-w-3 aspect-h-4">
                    <img
                      src={currentImageIndex === 0 ? selectedProduct.image : selectedProduct.additionalImages[currentImageIndex - 1]}
